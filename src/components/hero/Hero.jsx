  ...
  return (
    <HeroSection id="home">
      ...
      <HeroContainer>
        <ContentWrapper>
          <Badge>
            <img src={tickVector} width="14" alt="" />
          ...
          <Heading>
            ...
            <br />
            <GreenText>EXPERT GUIDANCE</GreenText>
            FOR BETTER
            <br />
            HEALTH PROTECTION.
          </Heading>
          ...
          <Description>
            ...
            you choose the right policy with clarity and confidence.
          </Description>

        <HeroForm openContact={openContact} />
        </ContentWrapper>
      </HeroContainer>
